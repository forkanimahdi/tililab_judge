...
export default function CandidateDetailsPage({ candidate, evaluations, authJudge }) {
    ...
    // --- SUBMIT EVALUATION ---
    const handleSubmit = () => {
        post(route("candidates.evaluate", candidate.id), { preserveScroll: true, data })
    }
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
                                ...
                                <div className="col-span-full flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                                    <div className="flex items-center gap-4 flex-wrap">
                                        ...
                                        <Button
                                            variant={data.decision === "discuter" ? "secondary" : "outline"}
                                    ...
                                    <Button
                                        ...
                                        disabled={!isModified || !data.decision || processing}
                                        className={`mt-4 sm:mt-0 w-full sm:w-auto text-white ${!isModified || !data.decision || processing ? "opacity-50 cursor-not-allowed" : ""}`}
                                    >
                                ...
                                <table className="w-full border border-gray-200 rounded-lg">
                                    <thead className="bg-gray-100">
                                        <tr>
                                            ...
                                            <th className="p3 text-center">Communication</th>
